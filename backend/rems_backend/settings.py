...
# ─── Caching (Shared across ASGI/WSGI processes) ──────────────────────────────
CACHES = {
    'default': {
...
if EMAIL_HOST_USER and EMAIL_HOST_PASSWORD:
    # Use real SMTP backend when credentials are provided in environment/dot-env
    ...
    # Fallback to console during development if credentials are empty
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'noreply@rems.com'
